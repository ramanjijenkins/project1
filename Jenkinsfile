...
stage('build && SonarQube analysis') {
          steps {
           ...
           withSonarQubeEnv('sonar') {
                     sh "/opt/sonar-scanner/bin/sonar-scanner -Dsonar.projectKey=demo-project -Dsonar.projectVersion=0.0.1 -Dsonar.sources=${projectName} -Dsonar.tests=${projectName} -Dsonar.test.inclusions=Project1/*.*.ipynb  -Dsonar.host.url=http://107.20.71.233:9001 -Dsonar.login=ab9d8f9c15baff5428b9bf18b0ec198a5b35c6bb"
                }
              }
        }
        }
